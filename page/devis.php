...
<body>
    ...
    <?php
    $_SESSION['id_agence_dep'];
    $_SESSION['id_agence_arriv'] = $_POST['id_agence_arriv'];
    $_SESSION['date_dep'] = $_POST['date_dep'];
    $_SESSION['heure_dep'] = $_POST['heure_dep'];
    $_SESSION['date_arriv'] = $_POST['date_arriv'];
    $_SESSION['heure_arriv'] = $_POST['heure_arriv'];
    $_SESSION['nom_ville'];
...
//    $result = executeSQL($insert_reserv);
    ...
    <form action="devis_rempli.php" method="post">
        ...
        <input type="submit" value="Valider"><br /><h5 id="erreur" style="color : red"></h5><br />
